...
void testar_R1_3_BPE_Manual() {
    ...
    // --- AQUI ESTÁ O QUE PEDISTE: MOSTRAR SEMPRE OS TOKENS ---
...
void testar_R2_1_ListaLigada() {
    ...
    adicionarDocumentoLista(&lista, "Doc1", "dummy"); // idx 0
    adicionarDocumentoLista(&lista, "Doc2", "dummy"); // idx 1
    adicionarDocumentoLista(&lista, "Doc3", "dummy"); // idx 2
...
void testar_R2_3_e_R2_4_IO() {
    ...
    // Limpezas
    libertarListaDocumentos(&lista); // Liberta v tambem pois esta associado
